...
import DevSaaS from '../components/sections/DevSaaS.vue'      // Novo: Substitui o ProjectsGrid
import AppleRepair from '../components/sections/AppleRepair.vue' // Novo: Seção exclusiva
